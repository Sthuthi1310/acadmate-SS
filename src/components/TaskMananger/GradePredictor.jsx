        ...
        <div className="cie-section">
          ...
          <div className="cie-summary">
            <div className="summary-item">
              Total CIE Raw: {cie1 + cie2 + cie3}/80
            </div>
            <div className="summary-item">
              CIE Scaled: {calculations.totalCie.toFixed(1)}/40
            </div>
        ...
        <div className="results-section">
          ...
          <div className="grade-results">
            {calculations.results.map(result => (
              <div key={result.grade} className={`grade-card ${result.achievable ? '' : 'not-achievable'}`} style={{ borderLeftColor: result.color }}>
                ...
                {result.fail && <div className="not-achievable-note">❌ Fail: CIE below minimum required (21/40)</div>}
